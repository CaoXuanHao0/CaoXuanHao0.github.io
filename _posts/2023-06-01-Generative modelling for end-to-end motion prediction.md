...
We parametrize both distributions as diagonal Gaussians with mean $$ μ \in R^L $and variance $$ σ^2 \in R^L $$ which are learnable, $$L$$ being the latent dimension: $$ P(Z|S) = N (μ_{t}, σ^2_{ t}) $$, $$ P(Z|S,Y_{GT}) = N (μ_{t,gt}, σ^2_{ t,gt}) $$.
